...
```shell
docker run --name streamlit-container -d -e OPENAI_API_KEY=$(aws ssm get-parameters --region ap-northeast-2 --name "/TEST/CICD/STREAMLIT/OPENAI_API_KEY" --query "Parameters[0].Value") -p 8501:8501 e7c7693b7737
